...
console.log(
  "¿Laptop disponible (stock: 5)?",
  verificarDisponibilidad(producto1)
); // Esperado: true
console.log(
  "¿Monitor disponible (stock: 0)?",
  verificarDisponibilidad(producto3)
); // Esperado: false
...
console.log(
  "¿2 Teclados disponibles (stock: 1)?",
  verificarDisponibilidad(producto4, 2)
); // Esperado: false
console.log(
  "¿25 Mouses disponibles (stock: 50)?",
  verificarDisponibilidad(producto2, 25)
); // Esperado: true
...
console.log(
  "Valor total Smartphone (800 × 15):",
  valorTotalInventario(producto5)
); // Esperado: 12000
...
console.log(
  "Producto gratis con 50% descuento:",
  aplicarDescuento(productoGratis, 50)
); // Esperado: 0
console.log(
  "Producto premium con 100% descuento:",
  aplicarDescuento(productoCaro, 100)
); // Esperado: 0
console.log(
  "¿Producto gratis disponible?",
  verificarDisponibilidad(productoGratis)
); // Esperado: true
console.log("¿0 productos disponibles?", verificarDisponibilidad(producto1, 0)); // Esperado: true
console.log(
  "Valor inventario producto gratis:",
  valorTotalInventario(productoGratis)
); // Esperado: 0
console.log(
  "Valor inventario producto premium:",
  valorTotalInventario(productoCaro)
); // Esperado: 20000
...
console.log(
  "¿Exactamente 5 Laptops disponibles?",
  verificarDisponibilidad(producto1, 5)
); // Esperado: true
console.log(
  "¿Exactamente 6 Laptops disponibles?",
  verificarDisponibilidad(producto1, 6)
); // Esperado: false
